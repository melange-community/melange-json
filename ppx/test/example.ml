...
type legacy_variant = LegacyA | LegacyB of int [@@deriving json] [@@json.no_args_variant_cases_as_arrays]
...
let of_json_cases = [
  ...
  C ({|"Empty"|}, shape_of_json, shape_to_json, Empty);
  (* legacy_variant: with [@@json.no_args_variant_cases_as_arrays], payloadless variants serialize as lists *)
