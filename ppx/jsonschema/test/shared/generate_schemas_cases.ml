...
let schemas =
  [
    ...
    Ppx_deriving_jsonschema_runtime.json_schema
      inline_record_disallow_extra_fields_jsonschema;
    Ppx_deriving_jsonschema_runtime.json_schema
      (generic_link_traffic_jsonschema string_jsonschema);
    Ppx_deriving_jsonschema_runtime.json_schema
      string_link_traffic_jsonschema;
    Ppx_deriving_jsonschema_runtime.json_schema
      (poly_variant_jsonschema int_jsonschema);
    Ppx_deriving_jsonschema_runtime.json_schema
      (multi_param_jsonschema int_jsonschema bool_jsonschema);
    Ppx_deriving_jsonschema_runtime.json_schema
      (param_list_jsonschema string_jsonschema);
    Ppx_deriving_jsonschema_runtime.json_schema
    ...
    Ppx_deriving_jsonschema_runtime.json_schema
      doc_comment_disabled_jsonschema;
    Ppx_deriving_jsonschema_runtime.json_schema
      doc_comment_override_jsonschema;
    Ppx_deriving_jsonschema_runtime.json_schema
      doc_comment_variant_jsonschema;
    Ppx_deriving_jsonschema_runtime.json_schema
      doc_comment_core_type_jsonschema;
    Ppx_deriving_jsonschema_runtime.json_schema
      doc_attribute_alias_jsonschema;
    Ppx_deriving_jsonschema_runtime.json_schema
      doc_comment_multiline_jsonschema;
    Ppx_deriving_jsonschema_runtime.json_schema
      doc_comment_poly_variant_jsonschema;
    Ppx_deriving_jsonschema_runtime.json_schema
      doc_comment_multiple_jsonschema;
    Ppx_deriving_jsonschema_runtime.json_schema
      doc_comment_poly_variant_override_jsonschema;
    Ppx_deriving_jsonschema_runtime.json_schema
    ...
    Ppx_deriving_jsonschema_runtime.json_schema
      with_format_record_jsonschema;
    Ppx_deriving_jsonschema_runtime.json_schema
      with_format_variant_jsonschema;
    Ppx_deriving_jsonschema_runtime.json_schema
      (grade_jsonschema int_jsonschema);
    ...
    Ppx_deriving_jsonschema_runtime.json_schema
      with_maximum_record_jsonschema;
    ...
    Ppx_deriving_jsonschema_runtime.json_schema
      minimum_core_type_int_jsonschema;
    Ppx_deriving_jsonschema_runtime.json_schema
      minimum_core_type_float_jsonschema;
    Ppx_deriving_jsonschema_runtime.json_schema
      minimum_maximum_record_jsonschema;
    Ppx_deriving_jsonschema_runtime.json_schema
      minimum_maximum_type_decl_int_jsonschema;
    Ppx_deriving_jsonschema_runtime.json_schema
      minimum_maximum_type_decl_float_jsonschema;
    Ppx_deriving_jsonschema_runtime.json_schema
      minimum_maximum_variant_jsonschema;
    Ppx_deriving_jsonschema_runtime.json_schema default_value_jsonschema;
    Ppx_deriving_jsonschema_runtime.json_schema
      default_with_module_type_jsonschema;
    Ppx_deriving_jsonschema_runtime.json_schema
      outer_default_record_with_option_jsonschema;
    Ppx_deriving_jsonschema_runtime.json_schema
      compact_variants_jsonschema;
    Ppx_deriving_jsonschema_runtime.json_schema
      compact_poly_variants_jsonschema;
    Ppx_deriving_jsonschema_runtime.json_schema
      Nonrec_type_alias.foo_jsonschema;
    Ppx_deriving_jsonschema_runtime.json_schema
      Nonrec_type_alias.X.foo_jsonschema;
    Ppx_deriving_jsonschema_runtime.json_schema
      Recursive_shapes.a_jsonschema;
    Ppx_deriving_jsonschema_runtime.json_schema
      Recursive_shapes.b_jsonschema;
    Ppx_deriving_jsonschema_runtime.json_schema
      Recursive_shapes.t_jsonschema;
    Ppx_deriving_jsonschema_runtime.json_schema
